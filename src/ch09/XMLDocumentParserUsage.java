...
public class XMLDocumentParserUsage {
    ...
    public static void main(String[] args) throws Exception {
        ...
        URL url = argc > 0 ? new URL(args[0]) : XMLDocumentParserUsage.class.getClassLoader().getResource("data/ch9/feed");
    ...
    private static void asyncParse1(URL url) throws Exception {
        XMLDocumentParser.newTask(url).setExecutor(es).setResultHandler(new XMLDocumentParser.ResultHandler() {
            @Override
    ...
    private static String queryTitle(Document document) {
        ...
        return ndTtile.getFirstChild().getNodeValue();
    }
